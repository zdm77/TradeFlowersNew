...
type
  ...
  public
    procedure init(tableName: string; isUniq, isNew: boolean; Id: Integer = 0; Name: string = '');
...
begin
  // если уникальность то проверяем
  if isUniq = true then
...
procedure TfrmOnlyName.init(tableName: string; isUniq, isNew: boolean; Id: Integer = 0;
  Name: string = '');
begin
